var reportBuilder = angular.module('reportBuilder', ['ngRoute', 'restangular', 'ngMaterial', 'ui.tree', 'ngAnimate', 'ngHandsontable', 'angularPikaday']);
...
reportBuilder.config(function($routeProvider, $httpProvider, $locationProvider) {
    ...
    $routeProvider.
        ...
        .when("/report/:reportId/design", {
        	controller: "desCtrl",
        	templateUrl: static('report_builder/partials/design.html')
        }).when("/report/generate/:reportId", {
        	controller: "genCtrl",
        	templateUrl: static('report_builder/partials/generate.html')
        })
